...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'airsense.waqi.base_url' => 'string',
            'airsense.waqi.token' => 'string',
            'airsense.waqi.timeout' => 'integer',
            'airsense.ai_service.url' => 'string',
            'airsense.ai_service.timeout' => 'integer',
            'airsense.stale_reading_hours' => 'integer',
            'airsense.max_station_distance_km' => 'integer',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'app.deployment_token' => 'string',
            'app.deployment_notification_emails' => 'array',
            ...
            'auth.email_change_alert_delay' => 'integer',
            'auth.verification.expire' => 'integer',
            'auth.registration_enabled' => 'boolean',
            'auth.social_auth_enabled' => 'boolean',
            ...
            'filesystems.links./Users/Salimi/Sites/others/airsense/airsense-backend/public/storage' => 'string',
            ...
            'larastarter.default_role' => 'string',
            'larastarter.roles.admin.name' => 'string',
            'larastarter.roles.admin.description' => 'string',
            'larastarter.roles.user.name' => 'string',
            'larastarter.roles.user.description' => 'string',
...
'view.paths','view.compiled','airsense.waqi.base_url','airsense.waqi.token','airsense.waqi.timeout',
'airsense.ai_service.url','airsense.ai_service.timeout','airsense.stale_reading_hours','airsense.max_station_distance_km','app.name',
...
'app.aliases.Vite','app.deployment_token','app.deployment_notification_emails','auth.defaults.guard','auth.defaults.passwords',
...
'auth.password_timeout','auth.email_change_alert_delay','auth.verification.expire','auth.registration_enabled','auth.social_auth_enabled',
...
'cache.prefix','cache.serializable_classes','cors.paths','cors.allowed_methods','cors.allowed_origins',
...
'filesystems.links./Users/Salimi/Sites/others/airsense/airsense-backend/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'mcp.custom_schemes','mcp.authorization_server','resend.api_key','resend.domain','resend.path',
'resend.webhook.secret','resend.webhook.tolerance','larastarter.default_role','larastarter.roles.admin.name','larastarter.roles.admin.description',
'larastarter.roles.user.name','larastarter.roles.user.description','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'signed','throttle','verified','registration.enabled','deployment.token',);
        registerArgumentsSet('routes', 
'boost.browser-logs','sanctum.csrf-cookie','resend.webhook','api.deployment.webhook','api.login',
'api.register','api.password.email','api.password.update','api.two-factor.verify','api.oauth.token',
'api.verification.verify','api.verification.send','api.email-change.verify','api.user','api.logout',
'api.oauth.unlink','api.two-factor.setup','api.two-factor.enable','api.two-factor.disable','api.two-factor.recovery-codes',
'api.two-factor.recovery-codes.regenerate','user.profile.update','user.password.update','user.avatar.upload','user.avatar.delete',
'api.user.email-change.request','api.user.email-change.resend','api.user.email-change.cancel','api.user.email-change.status','users.bulk-delete',
'users.resend-password-reset','users.index','users.store','users.show','users.update',
'users.destroy','roles.bulk-delete','roles.index','roles.store','roles.show',
'roles.update','roles.destroy',
'register','login','password.email','password.store','verification.verify',
'email-change.verify','verification.send','logout','two-factor.verify','two-factor.setup',
'two-factor.enable','two-factor.disable','two-factor.recovery-codes','two-factor.recovery-codes.regenerate','user.email-change.request',
'user.email-change.resend','user.email-change.cancel','user.email-change.status','oauth.redirect','oauth.callback',
'oauth.unlink','oauth.link','oauth.token','storage.local','storage.local.upload',);
...
'FRONTEND_URL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_TIMEZONE',
...
'MAIL_USERNAME','MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','RESEND_API_KEY',
'AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT',
'VITE_APP_NAME','EMAIL_CHANGE_ALERT_DELAY','VERIFICATION_EXPIRE_MINUTES','REGISTRATION_ENABLED','SOCIAL_AUTH_ENABLED',
'GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GITHUB_CLIENT_ID','GITHUB_CLIENT_SECRET','DEPLOYMENT_TOKEN',
'DEPLOYMENT_NOTIFICATION_EMAILS','WAQI_API_TOKEN','AI_SERVICE_URL',);
