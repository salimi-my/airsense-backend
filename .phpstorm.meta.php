...
'auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','auth.email_change_alert_delay',
'auth.verification.expire','auth.registration_enabled','auth.social_auth_enabled','cache.default','cache.stores.array.driver',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/Salimi/Sites/others/airsense/airsense-backend/public/storage','logging.default',
...
'larastarter.default_role','larastarter.roles.admin.name','larastarter.roles.admin.description','larastarter.roles.user.name','larastarter.roles.user.description',
...
'signed','throttle','verified','registration.enabled',);
        registerArgumentsSet('routes', 
'boost.browser-logs','sanctum.csrf-cookie','resend.webhook','api.login','api.register',
'api.password.email','api.password.update','api.two-factor.verify','api.oauth.token','api.verification.verify',
'api.verification.send','api.email-change.verify','api.user','api.logout','api.oauth.unlink',
'api.two-factor.setup','api.two-factor.enable','api.two-factor.disable','api.two-factor.recovery-codes','api.two-factor.recovery-codes.regenerate',
'user.profile.update','user.password.update','user.avatar.upload','user.avatar.delete','api.user.email-change.request',
'api.user.email-change.resend','api.user.email-change.cancel','api.user.email-change.status','users.bulk-delete','users.resend-password-reset',
'users.index','users.store','users.show','users.update','users.destroy',
'roles.bulk-delete','roles.index','roles.store','roles.show','roles.update',
'roles.destroy','register',
'login','password.email','password.store','verification.verify','email-change.verify',
'verification.send','logout','two-factor.verify','two-factor.setup','two-factor.enable',
'two-factor.disable','two-factor.recovery-codes','two-factor.recovery-codes.regenerate','user.email-change.request','user.email-change.resend',
'user.email-change.cancel','user.email-change.status','oauth.redirect','oauth.callback','oauth.unlink',
'oauth.link','oauth.token','storage.local','storage.local.upload',);
...
'EMAIL_CHANGE_ALERT_DELAY','VERIFICATION_EXPIRE_MINUTES','REGISTRATION_ENABLED','SOCIAL_AUTH_ENABLED','GOOGLE_CLIENT_ID',
'GOOGLE_CLIENT_SECRET','GITHUB_CLIENT_ID','GITHUB_CLIENT_SECRET','WAQI_API_TOKEN','AI_SERVICE_URL',);
