...
'auth.passwords.users.throttle','auth.password_timeout','auth.email_change_alert_delay','auth.verification.expire','auth.registration_enabled',
'auth.social_auth_enabled','cache.default','cache.stores.array.driver','cache.stores.array.serialize','cache.stores.session.driver',
...
'cache.stores.failover.stores','cache.prefix','cache.serializable_classes','cors.paths','cors.allowed_methods',
...
'filesystems.disks.s3.report','filesystems.links./Users/Salimi/Sites/others/airsense/airsense-backend/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'services.github.redirect','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'mcp.redirect_domains','mcp.custom_schemes','mcp.authorization_server','larastarter.default_role','larastarter.roles.admin.name',
'larastarter.roles.admin.description','larastarter.roles.user.name','larastarter.roles.user.description','ide-helper.filename','ide-helper.models_filename',
...
'boost.browser-logs','sanctum.csrf-cookie','api.login','api.register','api.password.email',
'api.password.update','api.two-factor.verify','api.oauth.token','api.verification.verify','api.verification.send',
'api.email-change.verify','api.user','api.logout','api.oauth.unlink','api.two-factor.setup',
'api.two-factor.enable','api.two-factor.disable','api.two-factor.recovery-codes','api.two-factor.recovery-codes.regenerate','user.profile.update',
'user.password.update','user.avatar.upload','user.avatar.delete','api.user.email-change.request','api.user.email-change.resend',
'api.user.email-change.cancel','api.user.email-change.status','users.bulk-delete','users.resend-password-reset','users.index',
'users.store','users.show','users.update','users.destroy','roles.bulk-delete',
'roles.index','roles.store','roles.show','roles.update','roles.destroy','register','login','password.email',
'password.store','verification.verify','email-change.verify','verification.send','logout',
'two-factor.verify','two-factor.setup','two-factor.enable','two-factor.disable','two-factor.recovery-codes',
'two-factor.recovery-codes.regenerate','user.email-change.request','user.email-change.resend','user.email-change.cancel','user.email-change.status',
'oauth.redirect','oauth.callback','oauth.unlink','oauth.link','oauth.token',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','EMAIL_CHANGE_ALERT_DELAY',
'VERIFICATION_EXPIRE_MINUTES','REGISTRATION_ENABLED','SOCIAL_AUTH_ENABLED','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET',
